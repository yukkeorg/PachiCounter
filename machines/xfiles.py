...
def output(counts, history):
  data_table = {
     'count':       util.decolate_number(counts[pcounter.COUNT_INDEX.COUNT], 3),
     ...
     'uzcount':     util.decolate_number(counts[pcounter.COUNT_INDEX.CHANCE], 2),
     'reserved':    util.decolate_number(counts[pcounter.COUNT_INDEX.BONUS], 3),
     'xrcount':     util.decolate_number(counts[COUNT_INDEX_XFILES_XR], 2),
